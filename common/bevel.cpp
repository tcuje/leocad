...
//Redefinimos el método rotarConector de la clase conector para el Bevel.
void Bevel::rotarConector(sirMat4d r,int tooth/*,unsigned short nTime,bool bAnimation,bool bAddKey*/)
{
	Conector *actual;
	sirMat4d C2W, A2W;
...
void Bevel::moverConector(sirVector3d t)
{
	Conector *pCon;
...
bool Bevel::Ultimo_contacto(sirVector3d pos1,sirVector3d pos2, sirVector3d t)
{
	int i;
	bool igual=true;
...
bool Bevel::rotarEjeZ(sirMat4d r)
{
...
double Bevel::anguloEntreEjes(sirVector4d ejeDinamico,sirVector4d ejeEstatico,sirMat4d *m)
{
