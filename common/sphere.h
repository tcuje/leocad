...
class Sphere : public Extreme
{
 ...
 public:
	...
	/**
	  ...
	  * La diferencia está en que si se reota respecto al eje Z del Sphere no se hace nada. Sinó, se llama al método de la clase base Extreme (Conector).
	 ...
	 */
	  ...
	  * La diferencia está en que si se reota respecto al eje Z del Sphere no se hace nada. Sinó, se llama al método de la clase base Extreme.
	  * @param r matriz de rotación.
	  * @param nTime
	  * @param bAnimation
	  * @param bAddKey
	 */
	  ...
	  * La diferencia está en que si se traslada en el eje Z del Sphere (+-) estamos deslizando, y por lo tanto no propagamos el mover.
