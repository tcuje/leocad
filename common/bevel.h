...
protected:
 ...
 public:
	  ...
	  */
	 Bevel(void) { dibujo=new Circulo_Variable(); }
	  ...
	  */
	 Bevel(int identificador,const char *nom,sirMat4d rot,Piece *pieza,float r,int d) : Gear(identificador,nom,rot,pieza,r,d) { dibujo=new Circulo_Variable(); }
	  ...
	  * @param pieza puntero a la pieza a la que pertenece el conector.
	  */
	 Bevel(int identificador,Piece *pieza) : Gear(identificador,pieza) { dibujo=new Circulo_Variable(); }
	  ...
	  */
	 Bevel(Bevel &c) : Gear(c) {}

	 /**
	  * Destructor de la clase Bevel.
	  ...
	  */
	 Bevel& operator=(Bevel &c); //Deberia llamar al del CONECTOR y añadir lo del puntero
