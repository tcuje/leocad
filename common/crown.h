...
protected:
 ...
 public:
	  ...
	  */
	 Crown(void) { dibujo=new Circulo_Variable(); }
	  ...
	  */
	 Crown(int identificador,const char *nom,sirMat4d rot,Piece *pieza,float r,int d) : Gear(identificador,nom,rot,pieza,r,d) { dibujo=new Circulo_Variable(); }
	  ...
	  * @param pieza puntero a la pieza a la que pertenece el conector.
	  */
	 Crown(int identificador,Piece *pieza) : Gear(identificador,pieza) { dibujo=new Circulo_Variable(); }
	  ...
	  */
	 Crown(Crown &c) : Gear(c) {}

	 /**
	  * Destructor de la clase Crown.
	  ...
	  */
	 Crown& operator=(Crown &c); //Deberia llamar al del CONECTOR y añadir lo del puntero
